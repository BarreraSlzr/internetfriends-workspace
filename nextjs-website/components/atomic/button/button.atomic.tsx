  ...
  ],
  {
    variants: {
      ...
      size: {
        xs: [
          styles.xs,
          'h-7 px-2 text-xs rounded-[var(--radius-xs)]',
        ],
        sm: [
          styles.sm,
        ...
        md: [
          styles.md,
          'h-10 px-4 text-sm rounded-[var(--radius-md)]',
        ],
        lg: [
          styles.lg,
          'h-12 px-6 text-base rounded-[var(--radius-lg)]',
        ],
        xl: [
          styles.xl,
          'h-14 px-8 text-lg rounded-[var(--radius-lg)]',
        ],
      },
      fullWidth: {
        true: 'w-full',
    ...
    const startIconElement = startIcon && (
      ...
      >
        {React.cloneElement(startIcon as React.ReactElement, {
          className: cn(getIconSize(), (startIcon as any)?.props?.className),
        })}
      </span>
    );
    ...
    const endIconElement = endIcon && (
      ...
      >
        {React.cloneElement(endIcon as React.ReactElement, {
          className: cn(getIconSize(), (endIcon as any)?.props?.className),
        })}
      </span>
    );
