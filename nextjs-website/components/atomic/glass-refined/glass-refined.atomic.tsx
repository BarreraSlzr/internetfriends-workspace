...
export const GlassRefinedAtomic = React.memo(
  React.forwardRef<HTMLElement, GlassRefinedAtomicProps>(
    (
      {
        children,
        className,
        ...
        bordered = true,
        disabled = false,
        "data-testid": testId = "glass-refined",
        as: Element = "div",
        ...props
      },
      ref,
      ...
      return (
        <Element
          ...
          className={cn(
            ...
            hover && prefersReducedMotion && !disabled && ["hover:shadow-lg"],
