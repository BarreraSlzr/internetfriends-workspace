    ...
    >
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="space-y-1">
          ...
          <Input
            ...
            className="bg-transparent border-b border-accent-medium rounded-none focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-accent-strong"
          />
        </div>
        <div className="space-y-1">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div className="space-y-1">
          ...
          >
            <SelectTrigger className="bg-transparent border-b border-accent-medium rounded-none focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-accent-strong">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
      ...
      <div className="space-y-1">
        ...
        <Textarea
          ...
          rows={6}
          maxLength={2000}
          className="bg-transparent border border-accent-medium focus-visible:ring-0 focus-visible:ring-offset-0 focus-visible:border-accent-strong resize-none rounded-none"
      ...
      <div className="flex justify-end">
        <Button
          type="submit"
          className="flex items-center gap-2 text-foreground surface-glass border-accent-medium px-8 py-3 rounded-sm hover:opacity-90 transition-opacity"
        >
