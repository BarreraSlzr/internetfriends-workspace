/**
 * gloo-effects-simple.ts
 *
 * Minimal GLSL effect functions mirrored from the landingpage repo.
 * Each effect is a String.raw template that defines:
 *   vec2 effect(vec2 p, float i, float time)
 *
 * The selected effect is injected into a fragment shader and called
 * inside a simple accumulation loop to distort coordinates.
 */
...
/**
 * List of available effect function sources.
 * One is chosen at random at mount in the simple WebGL background component.
 */
export const effectFunctions: string[] = [
  defaultEffect,
  spiralEffect,
  waveEffect,
  vortexEffect,
