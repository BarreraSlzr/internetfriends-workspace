...
export const StateNode: React.FC<StateNodeProps> = ({ data, selected }) => {
  ...
  return (
    <div className={cn("bg-gray-800 border-2 rounded-xl p-4 min-w-72 transition-all duration-200", getBorderColor(), getPulseAnimation())}>
      <Handle
        type="target"
      ...
      <div className="grid grid-cols-2 gap-3">
        {Object.entries(data.metrics).map(([key, value]) => (
          <div className key={key}="bg-gray-900 rounded-lg p-3 border border-gray-700">
