...
const curriculumData: CVData = {
    ...
    },
  {
      ...
      description:
        "Assisted in tech support of the company's tech devices and created content for the company's social networks.",
...

      {
          ...
          description:
            "Create content for the company's social networks, such as images, videos and texts to increase the engagement on potencial clients.",
          skillsUsed: [17, 18, 19],
        },
      {
          name: "Tech Support - Tier 3",
          description:
            "Assist the company's clients with their problems on the software and hardware of the company's products.",
          skillsUsed: [20, 21],
        },
      ],
      startDate: "Mar. 2015",
  ...
  _contactInfo: {
    ...
    {
        title: "Website",
        url: "https://BarreraSlzr.InternetFriends.xyz",
        icon: "web",
      },
    {
        title: "LinkedIn",
        url: "https://www.linkedin.com/in/barreraslzr/",
        icon: "linkedin",
      },
    {
        title: "GitHub",
        url: "https://github.com/barreraslzr",
        icon: "github",
      },
    {
        title: "WhatsApp",
        url: "https://wa.me/+523311654324",
        icon: "whatsapp",
      },
    ],
    _height: "178 cm",
...
// Export curriculum with non-underscore aliases for component compatibility
export const curriculum = {
  ...curriculumData,
  // Main properties
  professionalPosition: curriculumData._professionalPosition,
  jobExperiences: curriculumData._jobExperiences,
  skills: curriculumData._skills,

  // Contact info with nested aliases
  contactInfo: {

    ...curriculumData._contactInfo,
    email: curriculumData._contactInfo._email,
    phone: curriculumData._contactInfo._phone,
    fullname: curriculumData._contactInfo._fullname,
    timezone: curriculumData._contactInfo._timezone,
    isOnline: curriculumData._contactInfo._isOnline,
    bio: curriculumData._contactInfo._bio,
    urls: curriculumData._contactInfo._urls,
    height: curriculumData._contactInfo._height,
    sex: curriculumData._contactInfo._sex,
    nationality: curriculumData._contactInfo._nationality,
    location: curriculumData._contactInfo._location,
    localTime: curriculumData._contactInfo._localTime,
    availability: curriculumData._contactInfo._availability,
  },
