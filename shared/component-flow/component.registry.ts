...
class ComponentRegistry {
  ...
  public createPreviewNodeData(componentName: string,
...
export function registerInternetFriendsComponents() {
  ...
  // Example registration pattern: // componentRegistry.registerComponent({
...
export function createComponentEntry(id: string,
  path: string,
  component: ComponentType<any>,)
  overrides?: Partial<ComponentPreviewNodeData>)
