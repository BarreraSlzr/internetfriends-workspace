 ...
 *
 * This script addresses the remaining high-impact linting issues:
 * - More unused variables with complex patterns
...
Examples:
  bun scripts/final-cleanup.ts --dry-run
  bun scripts/final-cleanup.ts --file=components/header.tsx
  bun scripts/final-cleanup.ts

This script performs final comprehensive cleanup of:
- Complex unused variable patterns
