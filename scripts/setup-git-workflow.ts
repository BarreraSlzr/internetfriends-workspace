...
🚀 QUICK START COMMANDS: git start feature-name          # Start new feature
...
🔧 USEFUL ALIASES: git st        # Short status

git lg        # Pretty log
git cm "msg"  # Quick commit
git uncommit  # Undo last commit (keep changes)

📚 DOCUMENTATION: - .github/GIT_WORKFLOW_STRATEGY.md

- .github/pull_request_template.md

💡 NEXT STEPS: 1. Review and customize .github/GIT_WORKFLOW_STRATEGY.md

2. Set up branch protection rules on GitHub/GitLab
3. Configure CI/CD pipelines
4. Start your first feature: git start my-feature

🤖 AI INTEGRATION: This workflow is optimized for AI agent collaboration.
...
OPTIONS: --no-hooks              Skip git hooks setup)
...
EXAMPLES: bun scripts/setup-git-workflow.ts
