...
FEATURE COMMANDS: start-feature <name>     Start a new feature branch
...
HOTFIX COMMANDS: start-hotfix <name> <version>   Start an emergency hotfix

finish-hotfix <name> <version>  Finish hotfix and deploy

AI COMMANDS: start-ai <name>         Start AI feature development branch

UTILITY COMMANDS: status                  Show workflow status

help                    Show this help message

EXAMPLES: bun scripts/git-workflow.ts start-feature micro-ux-explorer
...
BRANCH NAMING CONVENTIONS: feature/    Feature development (feature/micro-ux-explorer)
